<?php
/**
* template for modal  Horizontal SignUp
*/
?>
<!-- Signup: Horizontal  -->
    ...
    <div class="modal-content">
      <div class="card card-row">
        <div class="row no-gutters">
          <div class="col-12 col-md-6 bg-cover card-img-left" style="background-image: url(/assets/photo-8.jpg);">

            <!-- Image (placeholder) -->
            <img src="<?php echo get_template_directory_uri() ?>/assets/photo-8.jpg" alt="..." class="img-fluid d-md-none invisible">
          ...
          <div class="col-12 col-md-6">
            <div class="card-body">
              ...
              <p class="mb-0 font-size-sm text-center text-muted">
                Already have an account? <a href="https://landkit.goodthemes.co/signin-illustration.html">Log in</a>.
              </p>
