...
function gelios_scripts() {
	...
	wp_enqueue_style( 'bootstrap-css', get_template_directory_uri() . '/lib/bootstrap/dist/bootstrap.min.css', array(), $css_version);
	...
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/lib/bootstrap/dist/bootstrap.min.js', array('jquery'),  $css_version, true );
