...
function prfx_admin_styles(){
	global $typenow;
	if( $typenow == 'post' ) {
		wp_enqueue_style( 'prfx_meta_box_styles', get_template_directory(). '/plugins/custom-meta-box-template/meta-box-styles.css' );
	}
}
...
function prfx_color_enqueue() {
	...
	if( $typenow == 'post' ) {
		...
		wp_enqueue_script( 'meta-box-color-js', get_template_directory() . '/plugins/custom-meta-box-template/meta-box-color.js', array( 'wp-color-picker' ), true );
	}
}
...
function prfx_image_enqueue() {
	...
	if( $typenow == 'post' ) {
		...
		wp_register_script( 'meta-box-image', get_template_directory() . '/plugins/custom-meta-box-template/meta-box-image.js', array( 'jquery' ), true );
